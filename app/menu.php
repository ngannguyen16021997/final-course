<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
  <div class="container">
    <a class="navbar-brand" href="index.php">Web ban hang</a>
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="dropdown01">
            <a class="dropdown-item" href="admin/users/index.php">Danh sách users</a>
            <a class="dropdown-item" href="admin/catalogs/index.php">Danh sách catalogs</a>
            <a class="dropdown-item" href="admin/products/index.php">Danh sách products</a>
          </div>
        </li>
        <li class="nav-item">
